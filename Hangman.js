...
function Hangman(){
	var mainFunc = this;
	this.words = ["amsterdam","bombay","connecticut","sunnyvale","tampa","fremont", "dresden", "salem", "orlando", "milwaukee", "missourie","boston",'bangkok','london', 'paris', 'singapore', 'istanbul','ankara','athens','baltimore', 'brussels', 'cairo', 'delhi', 'dublin', 'florence', 'jakarta', 'kathmandu' ],
	this.randomWord = [],
	this.currentWord = [],
	this.userGuess = [],
	...
	this.startGame = function (){
		...
		inquirer.prompt([
		{
			type:'confirm',
			name:"play",
			message:colors.yellow('Want to PLAY HANGMAN GAME - FIND CITY Names ? '),
			default:true
		}
		])
